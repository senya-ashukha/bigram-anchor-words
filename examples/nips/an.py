...
F, anc = anchor.anchor_model(
    collection, wrd_count=len(collection.id_to_words), k=150, metrics=[preplexity, coherence, uniq_top_of_topics])

anchor.print_topics(F, collection.id_to_words, anc, 'en_nips/an.txt')
